...
class AddProductFragmentTest {
    ...
    fun createDialog_notNullTest() {
        val scenario =
            launchFragment<AddProductFragment>(themeResId = R.style.Theme_Inventory) // importante definir el tema
        scenario.moveToState(Lifecycle.State.RESUMED) // Fargment ya visible
